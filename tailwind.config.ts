    ...
    extend: {
      ...
      colors: {
        ...
        status: {
          ...
          wrapup: "hsl(var(--status-wrapup))",
          "wrapup-foreground": "hsl(var(--status-wrapup-foreground))",
          pause: "hsl(var(--status-pause))",
          "pause-foreground": "hsl(var(--status-pause-foreground))",
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 0 0 hsl(var(--status-ready) / 0.4)" },
          "50%": { boxShadow: "0 0 0 8px hsl(var(--status-ready) / 0)" },
        },
        shimmer: {
